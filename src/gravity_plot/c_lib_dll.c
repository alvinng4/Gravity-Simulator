...
)
{
    ...
    real (*v_1)[3] = malloc(3 * objects_count * sizeof(real));
    real (*x_1)[3] = malloc(3 * objects_count * sizeof(real));
    real *vk = malloc(stages * objects_count * 3 * sizeof(real));
    real *xk = malloc(stages * objects_count * 3 * sizeof(real));    
    real (*temp_a)[3] = malloc(3 * objects_count * sizeof(real));
    real (*temp_v)[3] = malloc(3 * objects_count * sizeof(real));
    real (*temp_x)[3] = malloc(3 * objects_count * sizeof(real));
    real (*error_estimation_delta_v)[3] = malloc(3 * objects_count * sizeof(real));
    real (*error_estimation_delta_x)[3] = malloc(3 * objects_count * sizeof(real));
    real (*tolerance_scale_v)[3] = malloc(3 * objects_count * sizeof(real));
    real (*tolerance_scale_x)[3] = malloc(3 * objects_count * sizeof(real));
    ...
    while (1)
    {
        ...
        if (error <= 1 || *dt == tf * 1e-12)
        {
            // Advance step
            *t += *dt; 
            memcpy(x, x_1, 3 * objects_count * sizeof(real));
            memcpy(v, v_1, 3 * objects_count * sizeof(real));
            *count += 1;
